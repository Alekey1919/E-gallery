  ...
  image.addEventListener("click", () => {
    ...
    if (
      ...
      buttonsAndImg =
        ...
        '" alt="" id="overlay-image">';
      modalContent =
        '<div class="modal fade" id="game-info-firewatch" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Firewatch</h5><buttontype="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></buttontype=></div><div class="modal-body"><img src="./assets/images/covers/firewatch.png"alt="Firewatch Cover" class="game-cover"/><ul class="modal-body-list"><li lass="modal-body-list-item"><span class="span-bold">Release Date:</span> 9 FEB 2016</li><li class="modal-body-list-item"><span class="span-bold">Developer:</span> Campo Santo.</li><li class="modal-body-list-item"><span class="span-bold">Publisher:</span> Panic, Campo Santo.</li><li class="modal-body-list-item"><span class="span-bold">Genre:</span> Adventure, Walking Simultaor, Open World, Exploration.</li></ul></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button><a href="https://store.steampowered.com/app/383870/Firewatch/" target="_blank"><button type="button" class="btn btn-primary">  Steam Store</button></a></div></div></div></div>';
    } else if (
      path ===
      ...
      buttonsAndImg =
        ...
        '" alt="" id="overlay-image">';
      modalContent =
        '<div class="modal fade" id="game-info-sea-of-solitude" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Sea Of Solitude</h5><buttontype="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></buttontype=></div><div class="modal-body"><img src="./assets/images/covers/sea-of-solitude.jpg" alt="Sea Of Solitude Cover" class="game-cover"/><ul class="modal-body-list"><li lass="modal-body-list-item"><span class="span-bold">Release Date:</span> 5 Jul, 2019</li><li class="modal-body-list-item"><span class="span-bold">Developer:</span> Jo-Mei Games.</li><li class="modal-body-list-item"><span class="span-bold">Publisher:</span> Electronic Arts.</li><li class="modal-body-list-item"><span class="span-bold">Genre:</span> Adventure, Emodional, Dark, Story Rich.</li></ul></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button><a href="https://store.steampowered.com/app/1225590/Sea_of_Solitude/" target="_blank"><button type="button" class="btn btn-primary">  Steam Store</button></a></div></div></div></div>';
    } else if (
      path ===
